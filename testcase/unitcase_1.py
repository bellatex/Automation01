...
class FirstCase01(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(self):
        print("========所有FirstCase01执行前，运行一次=========")

    @classmethod
    def tearDownClass(self):
        print("========所有FirstCase01执行后，运行一次=========")
    ...
    def test_login_email_error(self):   
        ...
        self.assertTrue(email_result, 'this is emial_result Error!')
...
if __name__ == '__main__':
    ...
    #选择只执行其中某几个testcase
    suite.addTest(FirstCase01("test_login_pw_again_error"))
    suite.addTest(FirstCase01("test_login_email_error"))
